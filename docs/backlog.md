...
| Q10 | Name resolution and types | R1 for resolution (`ItemTree` → `DefMap`), but overloads, subclassing and `extend` have no R1 answer: R6, R7 (and R9, which carries R7 to Cangjie), and R3's Sema as the specification (D14) |
